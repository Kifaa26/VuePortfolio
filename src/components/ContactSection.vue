...
</svg></strong> Lotus River, Cape Town</p>
...
</svg></strong> 060 939 0467</p>
          <p><strong><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
...
</svg></strong> akifahpalekar@gmail.com</p>
</div>
</div>
</div>
      </div>
